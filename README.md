...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/buzz-milk-style
```

A live public deployment of this template is available at [https://buzz-milk-style.templates.workers.dev](https://buzz-milk-style.templates.workers.dev)
